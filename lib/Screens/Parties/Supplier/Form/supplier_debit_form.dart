...
import 'package:jewellery/Screens/Parties/Supplier/Controller/supplier_debit_controller.dart';

class SupplierDebitForm extends StatelessWidget {
  final SupplierDebitController controller = Get.put(SupplierDebitController());

  SupplierDebitForm({super.key});
