...
class SupplierEntryDetails extends StatefulWidget {
  const SupplierEntryDetails({super.key});

  @override
  State<SupplierEntryDetails> createState() => _SupplierEntryDetailsState();
}

class _SupplierEntryDetailsState extends State<SupplierEntryDetails> {
  @override
