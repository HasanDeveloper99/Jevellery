...
class CustomerDebitForm extends StatefulWidget {
  const CustomerDebitForm({super.key});

  @override
  _CustomerDebitFormState createState() => _CustomerDebitFormState();
}

class _CustomerDebitFormState extends State<CustomerDebitForm> {
