...
const kDarkGreenColor = Color.fromARGB(255, 9, 127, 13);
...
const kBGColor = LinearGradient(
  colors: [
    Color.fromARGB(255, 238, 229, 236), // Purple
    Color.fromARGB(255, 224, 227, 243), // Orange
  ],
